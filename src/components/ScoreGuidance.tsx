      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            <div className="mt-3 pl-8 sm:pl-0">
              <button
                onClick={() => onAction(item.actionTarget)}
                className="w-full sm:w-auto px-3 py-2 text-xs font-medium rounded-lg bg-white/10 hover:bg-white/20 text-white border border-white/10 transition-colors"
              >
                {item.actionLabel}
              </button>
            </div>
